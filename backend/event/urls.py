...
urlpatterns = [
    ...
    path('types/', views.EventTypeListView.as_view()),
    ...
    path('<uuid:uuid>/distribution/', views.EventDistributionView.as_view()),
    path('<uuid:uuid>/unload/', views.EventUnloadView.as_view()),
    path('<uuid:uuid>/clear-equipment/', views.EventClearEquipmentView.as_view()),
